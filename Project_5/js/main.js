...
Reflection: This file taught me how important it is to keep shared
application setup in one place while moving specific behaviors into smaller modules.
I learned how translation data, theme behavior, page startup, and feature initialization
can still work together cleanly after a refactor if each file has a clear role.

One challenge was preserving the older Project 4 behavior while introducing the new
Project 5 hidden-section flow and form validation. I also had to make sure the language
system covered the new visitor form labels, messages, and error text without breaking
the existing weather and content translations.

Changes addressed:
- Added hidden Log Visit launch support through js/page.js
- Added visitor form validation support through js/validation.js
- Kept translation, language toggle, theme toggle, gallery, weather, and shared site initialization here
*/
...
const translations = {
  en: {
    ...
    "visit.title": "Log Your Visit",
    "visit.intro": "Register your visit before you leave the site. This version validates your form entries locally and then shows a thank-you confirmation instead of saving data",
    "visit.form.nameLabel": "Full name",
    "visit.form.emailLabel": "Email address",
    "visit.form.phoneLabel": "Phone number",
    "visit.form.dateLabel": "Visit date",
    "visit.form.reasonLabel": "Reason for visiting",
    "visit.form.reasonPlaceholder": "Select a reason",
    "visit.form.reasonTourism": "Tourism",
    "visit.form.reasonStudy": "Study",
    "visit.form.reasonCulture": "Culture",
    "visit.form.reasonBusiness": "Business",
    "visit.form.messageLabel": "Message",
    "visit.form.submit": "Submit Visit",
    "visit.form.reset": "Clear Form",
    "visit.thanks.title": "Thank you for visiting Romania Roadbook",
    "visit.thanks.body": "Your visitor form passed validation. In this project step the information is not saved, but the form was submitted successfully",
    "visit.thanks.again": "Log Another Visit",
    "visit.errors.name": "Enter your full name before submitting",
    "visit.errors.email": "Enter a valid email address",
    "visit.errors.phone": "Enter a valid phone number or leave the field blank",
    "visit.errors.visitDate": "Choose a visit date",
    "visit.errors.reason": "Select a reason for visiting",
    "visit.errors.message": "Use at least 10 characters if you include a message",
    ...
    "weather.sectionTitle": "Weather Planner",
    "weather.sectionIntro": "Use the live forecast cards to compare conditions across Bucharest, Cluj-Napoca, Suceava, and Constanta before planning your route",
  ...
  ro: {
    ...
    "nav.media": "Media",
    "nav.contact": "Contact",
    "nav.visit": "Inregistreaza vizita",
    ...
    "visit.title": "Inregistreaza vizita",
    "visit.intro": "Inregistreaza-ti vizita inainte sa parasesti site-ul. Aceasta versiune valideaza local campurile formularului si apoi afiseaza un mesaj de multumire in loc sa salveze datele",
    "visit.form.nameLabel": "Nume complet",
    "visit.form.emailLabel": "Adresa de email",
    "visit.form.phoneLabel": "Numar de telefon",
    "visit.form.dateLabel": "Data vizitei",
    "visit.form.reasonLabel": "Motivul vizitei",
    "visit.form.reasonPlaceholder": "Alege un motiv",
    "visit.form.reasonTourism": "Turism",
    "visit.form.reasonStudy": "Studii",
    "visit.form.reasonCulture": "Cultura",
    "visit.form.reasonBusiness": "Afaceri",
    "visit.form.messageLabel": "Mesaj",
    "visit.form.submit": "Trimite vizita",
    "visit.form.reset": "Goleste formularul",
    "visit.thanks.title": "Multumim ca ai vizitat Romania Roadbook",
    "visit.thanks.body": "Formularul tau a trecut validarea. In acest pas al proiectului informatiile nu sunt salvate, dar trimiterea formularului a reusit",
    "visit.thanks.again": "Inregistreaza alta vizita",
    "visit.errors.name": "Introdu numele complet inainte de trimitere",
    "visit.errors.email": "Introdu o adresa de email valida",
    "visit.errors.phone": "Introdu un numar de telefon valid sau lasa campul gol",
    "visit.errors.visitDate": "Alege data vizitei",
    "visit.errors.reason": "Selecteaza motivul vizitei",
    "visit.errors.message": "Foloseste cel putin 10 caractere daca adaugi un mesaj",
    ...
    "weather.sectionTitle": "Planificator meteo",
    "weather.sectionIntro": "Foloseste cardurile cu prognoza live pentru a compara conditiile din Bucuresti, Cluj-Napoca, Suceava si Constanta inainte sa iti planifici traseul",
...
if (window.RoadbookPage) {
  window.RoadbookPage.init();
}

setupFadeIns();

if (window.RoadbookValidation) {
  window.RoadbookValidation.initVisitorForm();
}
